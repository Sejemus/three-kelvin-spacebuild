...
hook.Add("HUDPaint", "TKPH_Stats", function()
    ...
    draw.SimpleText("Score:", Hud.font, 5, Hud.tallEdge - 3, TK.HUD.Colors.text, TEXT_ALIGN_LEFT, TEXT_ALIGN_BOTTOM)
    draw.SimpleText(TK:Format(LocalPlayer():GetNWInt("TKScore", 0)), Hud.font, 122, Hud.tallEdge - 3, TK.HUD.Colors.text, TEXT_ALIGN_LEFT, TEXT_ALIGN_BOTTOM)
end)
